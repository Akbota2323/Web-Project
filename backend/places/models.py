...
class Place(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, related_name='places')  # FK #1
...
class Booking(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='bookings')  # FK #2
    place = models.ForeignKey(Place, on_delete=models.CASCADE, related_name='bookings')  # FK #3
